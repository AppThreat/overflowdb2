...
object StringPropertyFilter:
    ...
    def regexp[NodeType](trav: Traversal[NodeType])(
    ...
    def contains[NodeType](trav: Traversal[NodeType])(
      accessor: NodeType => String,
      value: String
    ): Traversal[NodeType] =
    ...
    def endsWith[NodeType](trav: Traversal[NodeType])(
      accessor: NodeType => String,
      value: String
    ): Traversal[NodeType] =
            ...
            case _ =>
                ...
                traversal.filter { node =>
                    ...
                    accessor(node).exists { value =>
                        ...
                        if iteration >= 2 && needleSet == null then
                            needleSet = needles.to(mutable.HashSet)

                        if needleSet == null then needles.contains(value)
                        else needleSet.contains(value)
                    }
                }
        end match
    end exactMultiple
end StringPropertyFilter
